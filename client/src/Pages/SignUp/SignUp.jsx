...
import Swal from "sweetalert2"; //a JavaScript library used to create beautiful, customizable pop-up alerts instead of the boring, native alert() or confirm() boxes.
...
function Signup({ onSwitch }) {
  ...
  //Dynamically updates the appropriate field in formData based on user input.
  const handleChange = (e) => {
    const { name, value } = e.target;
    setFormData({
      ...formData,
      [name]: value, //This is a JavaScript feature called computed property names. It allows you to dynamically set the key of an object using a variable.
    });
  };
  ...
  function validateUserData(fname, lname, username) {
    ...
    //.trim() removes any leading or trailing whitespace (e.g., " John " becomes "John").
